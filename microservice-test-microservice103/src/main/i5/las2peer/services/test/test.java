...
public class test extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "test-microservice103", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "test", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/cae-test/microservice-test-microservice103/blob/master/LICENSE.txt") ) )
  @Path("/")
