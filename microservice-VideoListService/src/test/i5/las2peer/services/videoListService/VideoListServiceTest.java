...
/**
 *
 * VideoListService - Test Class
 *
 * This class provides a basic testing framework for the microservice VideoListService. It was
...
public class VideoListServiceTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(VideoListService.class.getCanonicalName(),"0.1");

  private static final String mainPath = "videos";
  ...
  /**
   * 
   * Test for the getVideoList method.
   * 
   */
  @Test
  public void testgetVideoList() {
    ...
    try {
      ...
      System.out.println("Result of 'testgetVideoList': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
