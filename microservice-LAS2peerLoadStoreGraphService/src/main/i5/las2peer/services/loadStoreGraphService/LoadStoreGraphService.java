 ...
 */
@ServicePath("graphs")
public class LoadStoreGraphService extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "LAS2peerLoadStoreGraphService", version = "1.0",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Community-Application-Editor/microservice-LAS2peerLoadStoreGraphService/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final LoadStoreGraphService service = (LoadStoreGraphService) Context.getCurrent().getService();
  ...
  public Response getGraphList() {
    ...
    if(graphListAsJsonArray_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity(graphList.toJSONString()).build();
    }
    // noGraphExists
  ...
  public Response loadGraph(@PathParam("id") String id) {
    ...
    if(graphLoaded_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity(r.toJSONString()).build();
    }
    // internalError
    boolean internalError_condition = true;
    if(internalError_condition) {
  ...
  public Response storeGraph(String graph) {
    ...
    if(graphStored_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_CREATED).entity(r).build();
    }
    return null;
  }
