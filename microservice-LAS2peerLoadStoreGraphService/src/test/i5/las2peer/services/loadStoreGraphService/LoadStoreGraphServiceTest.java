...
/**
 *
 * LAS2peerLoadStoreGraphService - Test Class
 *
 * This class provides a basic testing framework for the microservice LAS2peerLoadStoreGraphService. It was
...
public class LoadStoreGraphServiceTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(LoadStoreGraphService.class.getCanonicalName(),"0.1");
